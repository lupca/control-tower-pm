...
| `topvnsport-web` | `/home/lupca/projects/topvnsport.com` | `projects/topvnsport-web/tasks/` (`topvnsport-web.md`) | ⏳ pending (new repo) | ⏳ pending | ⏳ pending | `true` |
...
| `agenticmatix` | `/home/lupca/projects/agenticmatix` | `projects/agenticmatix/tasks/` (`agenticmatix.md`) | ⏳ pending (greenfield) | ⏳ pending | ⏳ pending | `false` |
...
| **Agenticmatix** | `projects/agenticmatix/` | ✅ Hoàn thành | 9/9 | — | LangGraph redesign complete |
