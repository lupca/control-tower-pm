...
- [[WEB-006-verify-all-products-discount-e2e]] — Verify end-to-end: giảm giá scope 'tất cả sản phẩm' hiển thị đúng trên storefront (dispatched)
- [[WEB-007-audit-technical-debt-docs]] — Audit Technical Debt documentation - xác nhận nợ kỹ thuật còn hiệu lực (dispatched)
