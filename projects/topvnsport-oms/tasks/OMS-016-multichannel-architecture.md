...
prediction_factors:
  score: 0.5
  deductions:
    - "blast_radius > 15 files: -0.5"
    - "hits hub node (OrdersPageContent, OMS baseline migration): 0"
...
# OMS-016: OMS Multi-channel Architecture Implementation
...
See detailed implementation plan below (5 phases, 12 weeks).
