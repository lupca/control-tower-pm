...
1. Đọc `AGENTS.md` (đặc biệt mục 8 "Reconcile, đừng append") và `index.md` mục 2 (PROJECT REGISTRY) nếu chưa đọc trong phiên.
...
4. Ghi một entry vào `log.md` (`operation: ingest`, format `AGENTS.md` mục 6) — liệt kê: bao nhiêu ghi chú đã ingest, ghi chú nào reconcile vào task có sẵn vs tạo task mới.
